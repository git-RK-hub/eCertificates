...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"base.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 7:
            ...
            showAlert('error', _context3.t0.response);
...
if (_base.elements.uploadForm) {
  _base.elements.uploadForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var formData = new FormData();
    var file = document.getElementById('certificate');
    var userId = document.getElementById('uploadCerti').dataset.userid;
...
if (_base.elements.signupHead) {
  _base.elements.signupHead.addEventListener('click', function (e) {
    e.preventDefault();
    _base.elements.signupSection.style.display = 'grid';
  });
}

if (_base.elements.loginHead) {
  _base.elements.loginHead.addEventListener('click', function (e) {
    e.preventDefault();
    _base.elements.loginSection.style.display = 'grid';
  });
}

if (_base.elements.signupSection) {
  document.querySelector('.p9').addEventListener('click', function (e) {
    e.preventDefault();
    _base.elements.signupSection.style.display = 'none';
  });
}

if (_base.elements.loginSection) {
  document.querySelector('.p10').addEventListener('click', function (e) {
    e.preventDefault();
    _base.elements.loginSection.style.display = 'none';
  });
}
...
if (_base.elements.loginForm) {
  ...
  _base.elements.loginForm.addEventListener('submit', function (e) {
    ...
    (0, _authentication.login)(loginObj);
  });
}
...
if (_base.elements.signupForm) {
  ...
  _base.elements.signupForm.addEventListener('submit', function (e) {
    ...
    signupObj.confirmPassword = document.getElementById('confirmPassword').value;
    (0, _authentication.signup)(signupObj);
  });
}
